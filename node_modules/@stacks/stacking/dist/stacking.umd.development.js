(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@stacks/transactions'), require('bn.js'), require('@stacks/common'), require('bitcoinjs-lib')) :
  typeof define === 'function' && define.amd ? define(['exports', '@stacks/transactions', 'bn.js', '@stacks/common', 'bitcoinjs-lib'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['@stacks/stacking'] = {}, global.transactions, global.BN, global.common, global.bitcoinjsLib));
}(this, (function (exports, transactions, BN, common, bitcoinjsLib) { 'use strict';
  ...
  function btcAddressVersionToHashMode(btcAddressVersion) {
    switch (btcAddressVersion) {
      case 0:
        return transactions.AddressHashMode.SerializeP2PKH;

      case 111:
        return transactions.AddressHashMode.SerializeP2PKH;

      case 5:
        return transactions.AddressHashMode.SerializeP2SH;
  ...
  function getAddressHashMode(btcAddress) {
    try {
      var _address$fromBase58Ch = bitcoinjsLib.address.fromBase58Check(btcAddress),
  ...
  function decodeBtcAddress(btcAddress) {
    ...
    try {
      b58Result = bitcoinjsLib.address.fromBase58Check(btcAddress);
    } catch (error) {
      throw new InvalidAddressError(btcAddress, error);
    }
  ...
  function getBTCAddress(version, checksum) {
    var btcAddress = bitcoinjsLib.address.toBase58Check(checksum, new BN__default['default'](version).toNumber());
    return btcAddress;
  }
  ...
  var StackingClient = /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", common.fetchPrivate(url).then(function (res) {
                  return res.json();
                }));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", common.fetchPrivate(url).then(function (res) {
                  return res.json();
                }));
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return common.fetchPrivate(url).then(function (res) {
                  return res.json();
                });
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                return _context4.abrupt("return", common.fetchPrivate(url).then(function (res) {
                  return res.json();
                }));
            ...
            switch (_context5.prev = _context5.next) {
              case 0:
                return _context5.abrupt("return", this.getAccountStatus().then(function (res) {
                  ...
                  return new BN__default['default'](balanceHex, 'hex');
                }));
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 2:
                ...
                _context9.t0 = BN__default['default'];
                _context9.next = 6;
                return this.getPoxInfo();
            ...
            switch (_context10.prev = _context10.next) {
              case 0:
                ...
                return _context10.abrupt("return", Promise.all([balancePromise, poxInfoPromise]).then(function (_ref4) {
                  ...
                  var hashModeBuffer = transactions.bufferCV(new BN__default['default'](hashMode, 10).toArrayLike(Buffer));
                  var hashbytes = transactions.bufferCV(data);
                  var poxAddressCV = transactions.tupleCV({
                    hashbytes: hashbytes,
                  ...
                  return transactions.callReadOnlyFunction({
                    network: _this.network,
                    contractName: contractName,
                    contractAddress: contractAddress,
                    functionName: 'can-stack-stx',
                    senderAddress: _this.address,
                    functionArgs: [poxAddressCV, transactions.uintCV(balance.toString()), transactions.uintCV(poxInfo.reward_cycle_id), transactions.uintCV(cycles.toString())]
                  });
                }).then(function (responseCV) {
                  if (responseCV.type === transactions.ClarityType.ResponseOk) {
                    return {
                      eligible: true
                    };
                  } else {
                    ...
                    return {
                      eligible: false,
                      reason: StackingErrors[+transactions.cvToString(errorCV.value)]
                    };
                  }
                }));
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 3:
                ...
                _context11.next = 8;
                return transactions.makeContractCall(_extends({}, txOptions, {
                  senderKey: privateKey
                }));

              case 8:
                tx = _context11.sent;
                return _context11.abrupt("return", transactions.broadcastTransaction(tx, txOptions.network));
        ...
        return runtime_1.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 8:
                tx = _context12.sent;
                return _context12.abrupt("return", transactions.broadcastTransaction(tx, txOptions.network));
        ...
        return runtime_1.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              ...
              case 8:
                tx = _context13.sent;
                return _context13.abrupt("return", transactions.broadcastTransaction(tx, txOptions.network));
        ...
        return runtime_1.wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              ...
              case 8:
                tx = _context14.sent;
                return _context14.abrupt("return", transactions.broadcastTransaction(tx, txOptions.network));
        ...
        return runtime_1.wrap(function _callee15$(_context15) {
          while (1) {
            switch (_context15.prev = _context15.next) {
              ...
              case 7:
                tx = _context15.sent;
                return _context15.abrupt("return", transactions.broadcastTransaction(tx, txOptions.network));
    ...
    _proto.getStackOptions = function getStackOptions(_ref9) {
      ...
      var hashModeBuffer = transactions.bufferCV(new BN__default['default'](hashMode, 10).toArrayLike(Buffer));
      var hashbytes = transactions.bufferCV(data);
      var address = transactions.tupleCV({
        hashbytes: hashbytes,
        version: hashModeBuffer
      });
      ...
      var txOptions = {
        ...
        functionArgs: [transactions.uintCV(amountMicroStx.toString(10)), address, transactions.uintCV(burnBlockHeight), transactions.uintCV(cycles)],
    ...
    _proto.getDelegateOptions = function getDelegateOptions(_ref10) {
      ...
      if (poxAddress) {
        ...
        var hashModeBuffer = transactions.bufferCV(new BN__default['default'](hashMode, 10).toArrayLike(Buffer));
        var hashbytes = transactions.bufferCV(data);
        address = transactions.someCV(transactions.tupleCV({
          hashbytes: hashbytes,
          version: hashModeBuffer
        }));
      }
      ...
      var txOptions = {
        ...
        functionArgs: [transactions.uintCV(amountMicroStx.toString(10)), transactions.standardPrincipalCV(delegateTo), untilBurnBlockHeight ? transactions.someCV(transactions.uintCV(untilBurnBlockHeight)) : transactions.noneCV(), address ? address : transactions.noneCV()],
        validateWithAbi: true,
        network: network
      };
      return txOptions;
    ...
    _proto.getDelegateStackOptions = function getDelegateStackOptions(_ref11) {
      ...
      var txOptions = {
        ...
        functionArgs: [transactions.standardPrincipalCV(stacker), transactions.uintCV(amountMicroStx.toString(10)), address, transactions.uintCV(burnBlockHeight), transactions.uintCV(cycles)],
        validateWithAbi: true,
        network: network
      };
    ...
    _proto.getStackAggregationCommitOptions = function getStackAggregationCommitOptions(_ref12) {
      ...
      var txOptions = {
        ...
        functionArgs: [address, transactions.uintCV(rewardCycle)],
        validateWithAbi: true,
        network: network
      };
      return txOptions;
          ...
          while (1) {
            switch (_context16.prev = _context16.next) {
              ...
              case 6:
                ...
                return _context16.abrupt("return", transactions.callReadOnlyFunction({
                  contractAddress: contractAddress,
                  contractName: contractName,
                  functionName: functionName,
                  senderAddress: this.address,
                  functionArgs: [transactions.standardPrincipalCV(this.address)],
                  network: this.network
                }).then(function (responseCV) {
                  if (responseCV.type === transactions.ClarityType.OptionalSome) {
                  ...
                  } else if (responseCV.type === transactions.ClarityType.OptionalNone) {
                    return {
                      stacked: false
                    };
                  } else {
    ...
    _proto.modifyLockTxFee = function modifyLockTxFee(_ref13) {
      ...
      tx.payload.functionArgs[0] = transactions.uintCV(new BN__default['default'](amountMicroStx.toString(10), 10).sub(fee).toArrayLike(Buffer));
      return tx;
    };
    ...
    _proto.parseContractId = function parseContractId(contract) {
      ...
      if (parts.length !== 2 || !transactions.validateStacksAddress(parts[0]) || parts[1] !== 'pox') {
...
//# sourceMappingURL=stacking.umd.development.js.map
